...
int main() {
  ...
  while(option!=8) {
      ...
      case 1:
	{
	  ...
	  scanf("%zu",&newKey);
	  newInt=(size_t*) malloc(sizeof(size_t));
	  *newInt=newKey;
      ...
      case 3:
	{
	  ...
	  if ( ( newNode = RBExactQuery(tree,&newKey) ) ) {/*assignment*/
	    printf("data found in tree at location %zu\n",(size_t)newNode);
	  } else {
